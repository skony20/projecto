...
<div class="products-view">
    ...
    <p>
        ...
        <?= Html::a(Html::button('Pokaż w sklepie', ['title' => 'Pokaz w sklepie', 'class' => 'btn btn-warning float-right']) , 'https://projekttop.pl/projekt/'.$model->productsDescriptons->nicename_link.'.html', ['target'=>'_blank']);?>
