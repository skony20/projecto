...
<body style="font-family: Verdana">
    ...
    <div style="background-color:#f5f9fc;padding:0;">
        <img src="http://projekttop.pl/img/logo.png" style="padding:5px;"/>
    </div>
    <?= $content ?>
    <br><br>
    <span style="font-size:10px;">Ten mail został wygenerowany automatycznie nie ma potrzeby odpowiadać na niego.</span>
    <br>
    ...
    <p>Warunki zakupów: <?= Html::a('Regulamin sklepu','http://projekttop.pl/regulamin') ?> | <?= Html::a('Zwrot towaru', 'http://projekttop.pl/zwrot') ?> | <?= Html::a('Polityka prywatności', 'http://projekttop.pl/polityka-prywatnosci') ?></p>
    </div>
    <?php $this->endBody() ?>
</body>
</html>
