...
class Products extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(ProductsImages::className(), ['products_id' => 'id'])->orderBy(['image_type_id' =>SORT_ASC],['name' => SORT_ASC],['FIELD(description, NULL, "Wnętrze", "Front domu", "Tył domu", "Bok 1", "Bok 2")' => SORT_ASC]);
    }
